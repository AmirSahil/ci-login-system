    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mr-4">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                ...
                <span class="mr-2 d-none d-lg-inline text-gray-600 small mr-3"> <?php echo $this->session->userdata['admin_first_name']?></span>
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item p-3" href="<?php echo base_url();?>admin/logout" data-toggle="modal" data-target="#logoutModal">
